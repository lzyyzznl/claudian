...
export interface DecodedOmpRecoveryPrompt {
  currentInput: string | null;
}

export function encodeOmpRecoveryPrompt(
...
export function decodeOmpRecoveryPrompt(prompt: string): DecodedOmpRecoveryPrompt | null {
