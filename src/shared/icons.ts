import type { ProviderIconSvg, ProviderSvgChild, ProviderSvgPathChild } from '../core/providers/types';
...
function ompIconPaths(glyphFill: string): ProviderSvgPathChild[] {
  return [
    { tag: 'path', attributes: { d: 'M10 8H110V20H10Z', fill: glyphFill } },
    { tag: 'path', attributes: { d: 'M25 20H37V82H25Z', fill: glyphFill } },
    { tag: 'path', attributes: { d: 'M75 20H87V65H75Z', fill: glyphFill } },
    { tag: 'path', attributes: { d: 'M71 55H91V71H71Z', fill: '#f97316' } },
    { tag: 'path', attributes: { d: 'M76 59H79V67H76Z', fill: '#0d0d0d' } },
    { tag: 'path', attributes: { d: 'M82 59H85V67H82Z', fill: '#0d0d0d' } },
    { tag: 'path', attributes: { d: 'M18 12a2 2 0 100 4 2 2 0 100-4Z', fill: '#f97316', opacity: '0.8' } },
    { tag: 'path', attributes: { d: 'M102 12a2 2 0 100 4 2 2 0 100-4Z', fill: '#f97316', opacity: '0.8' } },
  ];
}
...
export const OMP_PROVIDER_ICON: ProviderIconSvg = {
  ...
  children: [
    {
      tag: 'g',
      attributes: { class: 'claudian-provider-icon-variant claudian-provider-icon-variant--light' },
      children: ompIconPaths('#211E1E'),
    },
    {
      tag: 'g',
      attributes: { class: 'claudian-provider-icon-variant claudian-provider-icon-variant--dark' },
      children: ompIconPaths('#FAFAFA'),
    },
  ],
};
